...
<body>
    <div class="fondinsc">
        <div class="row g-3  rounded shadow text-center form-center" style="background-color: #b22222;">
            <div class="h1">
                <H1>Inscription</H1>
            </div>
            <hr><br>
                            ...
                            <div class="modal-body">
                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="radio" name="flexRadioDefault" value="<?php echo "$i" ?>" id="flexRadioDefault<?php echo "$i" ?>" required>
            ...
            <!-- <p>
        <label for="/musee_piscine/avatar/">choisi ton avatar:</label>
    ...
    if (isset($_POST["bouton"])) {
        ...
        if ($mdp == $mdp2) {
            ...
            if ($mail != $ligne["mail"]) {
                $res = mysqli_query($id, "insert into user value (null,'$nom','$prenom','$mail','$adresse','$cp','$mdp','$avatar',0,0)");
