...
<body>
  ...
  if (isset($_POST["bouton"])) {
    ...
    // if (!empty($avatar)) {
    //   $res = mysqli_query($id, "insert into user value (null,'$nom','$prenom','$mail','$adresse','$cp','$mdp','0.jpg',0,0)");echo "Inscription réussie ! <br>Chargement de la page d'inscription...";
    //   header('refresh:3;url=expo.php');
    //   exit();
    // }
